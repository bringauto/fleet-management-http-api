...
class Test_Creating_Records(api_test.TestCase):
    ...
    def test_adding_single_record_to_database_succesfully(self):
        ...
        retrieved_obj = _db_access.get(tenant=TEST_TENANT, base=models.TestItem)[0]
    ...
    def test_adding_multiple_records_to_database_succesfully(self):
        ...
        retrieved_objs = _db_access.get(tenant=TEST_TENANT, base=models.TestItem)
    ...
    def test_single_failure_prevents_all_records_from_uploading_to_database(self):
        ...
        response = _db_access.add(TEST_TENANT, test_obj_1, test_obj_2, test_obj_3, auto_id=False)
        self.assertEqual(response.status_code, 400)
        records = _db_access.get(tenant=TEST_TENANT, base=models.TestItem)
...
class Test_Sending_And_Retrieving_From_Database(api_test.TestCase):
    ...
    def test_table_is_initially_empty(self):
        objs_out = _db_access.get(tenant=TEST_TENANT, base=models.TestItem)
    ...
    def test_data_retrieved_are_equal_to_data_sent(self):
        ...
        _db_access.add(TEST_TENANT, data_in)
        data_out = _db_access.get(tenant=TEST_TENANT, base=models.TestItem)[0]
    ...
    def test_filter_records_using_equal_to_attribute_to_get_only_records_whose_attributes_equal_to_something(
        ...
        objs_out = _db_access.get(
            tenant=TEST_TENANT, base=models.TestItem, criteria={"test_int": lambda x: x == 5}
        )
    ...
    def test_filter_records_using_attribute_criteria(self):
        ...
        _db_access.add(TEST_TENANT, test_obj_1, test_obj_2)
        objs_out = _db_access.get(
            tenant=TEST_TENANT, base=models.TestItem, criteria={"test_int": lambda x: x < 6}
        )
        self.assertEqual(objs_out[0].test_int, test_obj_1.test_int)
        objs_out = _db_access.get(
            tenant=TEST_TENANT, base=models.TestItem, criteria={"test_int": lambda x: x > 6}
...
class Test_Updating_Records(api_test.TestCase):
    ...
    def test_updating_an_existing_record(self):
        ...
        _db_access.update(TEST_TENANT, updated_obj)
        retrieved_obj = _db_access.get(
            tenant=TEST_TENANT, base=models.TestItem, criteria={"id": lambda x: x == 1}
        )[0]
    ...
    def test_updating_non_existing_record_yields_404_code(self):
        ...
        response = _db_access.update(TEST_TENANT, updated_obj)
    ...
    def test_updating_multiple_records_succesfully(self):
        ...
        _db_access.update(TEST_TENANT, updated_obj_1, updated_obj_2)
        retrieved_objs = _db_access.get(tenant=TEST_TENANT, base=models.TestItem)
    ...
    def test_updating_multiple_records_with_one_failure_prevents_all_records_from_updating(self):
        ...
        _db_access.add(TEST_TENANT, obj_1, obj_2)
        ...
        response = _db_access.update(TEST_TENANT, updated_obj_1, updated_obj_2)
        self.assertEqual(response.status_code, 404)
        retrieved_objs = _db_access.get(tenant=TEST_TENANT, base=models.TestItem)
...
class Test_Deleting_Database_Record(api_test.TestCase):
    ...
    def test_deleting_an_existing_record(self):
        ...
        _db_access.add(TEST_TENANT, test_obj)
        _db_access.delete(TEST_TENANT, base=models.TestItem, id_=7)
        retrieved_obj = _db_access.get(
            tenant=TEST_TENANT, base=models.TestItem, criteria={"id": lambda x: x == 7}
        )
        self.assertListEqual(retrieved_obj, [])

    def test_deleting_non_existing_record_yields_404_code(self):
        nonexistent_obj_id = 112
        response = _db_access.delete(TEST_TENANT, base=models.TestItem, id_=nonexistent_obj_id)
        self.assertEqual(response.status_code, 404)
...
class Test_Deleting_N_Database_Records(api_test.TestCase):
    ...
    def test_deleting_n_records_with_least_ids(self):
        test_obj_1 = models.TestItem(test_str="test_string", test_int=5)
        test_obj_2 = models.TestItem(test_str="test_string", test_int=5)
        test_obj_3 = models.TestItem(test_str="test_string", test_int=5)
        _db_access.add(TEST_TENANT, test_obj_3, test_obj_1, test_obj_2)
    ...
    def test_deleting_n_records_with_highest_ids(self):
        ...
        test_obj_3 = models.TestItem(id=4, test_str="test_string", test_int=5)
        _db_access.add(TEST_TENANT, test_obj_3, test_obj_1, test_obj_2)
    ...
    def test_removing_n_filtered_records(self):
        test_obj_1 = models.TestItem(test_str="test_string", test_int=-1)
        test_obj_2 = models.TestItem(test_str="test_string", test_int=1)
        test_obj_3 = models.TestItem(test_str="test_string", test_int=-1)
        test_obj_4 = models.TestItem(test_str="test_string", test_int=1)
        test_obj_5 = models.TestItem(test_str="test_string", test_int=-1)
        test_obj_6 = models.TestItem(test_str="test_string", test_int=1)
        _db_access.add(
            TEST_TENANT,
            test_obj_1,
            test_obj_2,
        ...
        remaining_objs_with_negative_test_int = _db_access.get(
            tenant=TEST_TENANT, base=models.TestItem, criteria={"test_int": lambda x: x < 0}
        )
        test_obj_5.id = 5
