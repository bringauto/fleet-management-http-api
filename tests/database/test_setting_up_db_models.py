...
class Test_Setting_Maximum_Number_Of_Car_And_Order_States(unittest.TestCase):
    ...
    def test_maximum_number_of_car_action_states_must_be_positive_integer(self):
        _db_models.CarActionStateDB.set_max_n_of_stored_states(1)
        self.assertEqual(_db_models.CarActionStateDB.max_n_of_stored_states(), 1)
        _db_models.CarActionStateDB.set_max_n_of_stored_states(8)
        self.assertEqual(_db_models.CarActionStateDB.max_n_of_stored_states(), 8)
        _db_models.CarActionStateDB.set_max_n_of_stored_states(0)
        self.assertEqual(_db_models.CarActionStateDB.max_n_of_stored_states(), 8)
        _db_models.CarActionStateDB.set_max_n_of_stored_states(-1)
        self.assertEqual(_db_models.CarActionStateDB.max_n_of_stored_states(), 8)
