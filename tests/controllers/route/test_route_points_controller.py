...
class Updating_Route_Points(unittest.TestCase):
    ...
    def test_updating_route_points(self):
        ...
        with self.app.test_client() as c:
            c.post('/v2/management/route', json=self.route)
            c.post('/v2/management/routepoints', json=RoutePoints(id=12, route_id=12, points=old_points))
            ...
            c.post('/v2/management/routepoints', json=RoutePoints(id=12, route_id=12, points=new_points))
