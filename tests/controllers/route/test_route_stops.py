...
class Test_Defining_Route_List_Of_Stops(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.stop_A = Stop(name="test_stop_A", position=GNSSPosition(latitude=49, longitude=17, altitude=450))
        self.stop_B = Stop(name="test_stop_B", position=GNSSPosition(latitude=49.2, longitude=17, altitude=440))
        self.stop_C = Stop(name="test_stop_C", position=GNSSPosition(latitude=49.1, longitude=16.9, altitude=430))
        self.stop_D = Stop(name="test_stop_D", position=GNSSPosition(latitude=49.3, longitude=16.8, altitude=420))
