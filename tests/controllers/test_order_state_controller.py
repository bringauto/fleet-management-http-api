...
class Test_Getting_All_Order_States_For_Given_Order(unittest.TestCase):
    ...
    def test_getting_all_order_states_by_setting_since_parameter_to_zero(self):
    ...
    def test_not_specifying_since_parameter_makes_the_response_to_include_all_states_for_given_order(self):
        order_state_1 = OrderState(id=3, status="to_accept", order_id=12)
        order_state_2 = OrderState(id=7, status="canceled", order_id=12)
        with self.app.test_client() as c:
            c.post("/v2/management/orderstate", json=order_state_1)
...
class Test_Getting_Order_State_For_Given_Order(unittest.TestCase):
    ...
    def test_getting_order_state_for_existing_order_after_state_has_been_created_yields_list_with_state(
        self,
    ):
        order_state_1 = OrderState(id=3, status="to_accept", order_id=12)
