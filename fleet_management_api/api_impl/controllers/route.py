...
def create_routes(tenant: str = "") -> _Response:
    """Post a new route.
...
def delete_route(route_id: int, tenant: str = "") -> _Response:
...
def get_routes(tenant: str = "") -> list[_Route]:
...
def update_routes(tenant: str = "") -> _Response:
