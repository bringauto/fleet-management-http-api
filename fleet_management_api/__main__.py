...
from fleet_management_api.api_impl.auth_controller import init_security, set_auth_params
...
if __name__ == "__main__":
    ...
    try:
        configure_logging("Fleet Management HTTP API", args.config.logging)
